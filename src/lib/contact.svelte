...
<div class="min-h-screen flex flex-col xl:flex-row justify-center items-center p-4">
    <p class="max-w-xl mx-4 my-16 xl:m-32 text-lg">
        Want to hire me, ask about one of my projects, or just want to say hello? Feel free to send me a message in the
        contact form. I will try to respond as soon as possible.
        <br />
        <br />
    ...
    <form
        ...
        <Label for="name" label="NAME">
            <input type="text" name="name" id="name" required class="bg-transparent h-16 pt-6 px-3 outline-none" />
        </Label>
        <Label for="email" label="EMAIL">
            <input type="email" name="email" id="email" required class="bg-transparent h-16 pt-6 px-3 outline-none" />
        </Label>
        <Label for="body" label="MESSAGE">
            <textarea name="body" required class="bg-transparent mt-8 px-3 outline-none" rows={10}></textarea>
        </Label>
        <button
            type="submit"
